...
4. มีการ up level โดย level 0 : ใช้ 150 exp , level 1 : ใช้ 300 exp, เพิ่มขึ้นเรื่อยๆ ถึง level 10 
5. ภารกิจ ประจำวัน อดอาหารครบตามที่กำหนด +50 exp, บันทึกความรู้สึก +50 exp, การกดทำ IF +50 exp, เข้าไปดูสถิติ +50 exp
6. มี Avatar โดยจะเป็นรูปภาพที่เปลียนไปตาม level 
